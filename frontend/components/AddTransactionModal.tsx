...
interface AddTransactionModalProps {
  onClose: () => void;
  onAddTransaction: (transacao: Transacao) => void;
}

const AddTransactionModal = ({ onClose, onAddTransaction }: AddTransactionModalProps) => {
...
export default AddTransactionModal; // Exportação correta