...
export default function Dashboard() {
  ...
  const { transactions, investimentos, loading, error } = useFinance();
      ...
      <div className="flex-1 flex flex-col overflow-y-auto min-h-screen pt-16">
        ...
        <div className="p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <p className="text-2xl font-bold text-green-500 mt-2">R$ {totalReceitas - totalDespesas}</p>
          ...
          >
            ...
            <p className="text-2xl font-bold text-blue-500 mt-2">R$ {totalReceitas}</p>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
          ...
          >
            ...
            <p className="text-2xl font-bold text-red-500 mt-2">R$ {totalDespesas}</p>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
